      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Heading style={global.heading}>Thank you for yur order!</Heading>
          ...
          <Section className="paddingY">
            <Row>
                <Text style={{...footer.text, paddingTop: 30, paddingBottom: 30}}>
                    Please contact us if you have any questions. (If you reply to this emaill, we won't be able to see it.)
                </Text>
            </Row>
            <Row>
                <Text style={footer.text}>
                    &copy; PilloweXpress.ng All rights reserved.
                </Text>
            </Row>
          </Section>
